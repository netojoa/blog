        ...
        function (_) {
            return {
                initialized: function () {
                    ...
                    this.SettingsForm.IdentifierFieldId.on("change:SelectedItem", this.validate, this);
                ...
                validate: function () {
                    ...
                    if (this.SettingsForm.IdentifierFieldId.SelectedValue != "") {
                ...
                loadDone: function (parameters) {
                    ...
                    this.setEmailFieldData(this.SettingsForm.IdentifierFieldId, getFields(), this.Parameters["identifierFieldId"]);
                    this.validate();
                },
                getData: function () {
                    this.Parameters["identifierFieldId"] = this.SettingsForm.IdentifierFieldId.SelectedValue;
